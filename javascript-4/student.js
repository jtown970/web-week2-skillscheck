...
// CODE HERE
let faveColors = ['yellow', 'green', 'red']
//////////////////Step 2////////////////////
...
let me = {
  firstName: 'Jason',
  superHeroName: 'the Subterranean Carpenter',
  homeTown: 'Estes Park',
  superPowers: ['making the Deepest of house', 'epic bass lines', 'putting other in a trance'],
